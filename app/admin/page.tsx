...
export default async function AdminOverview() {
  ...
  const stats = [
    ...
    { label: 'الأسئلة', value: questionCount ?? 0 },
  ];
    ...
    <>
      ...
      <section className="max-w-[1140px] mx-auto px-6 py-14">
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <Link href="/admin/students" className="card p-6 flex-1 hover:border-goldDim transition">
          ...
          <Link href="/admin/lessons" className="card p-6 flex-1 hover:border-goldDim transition">
